                ...
                <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="col-md-2 control-lable" for="Product Name">Name</label>
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.user.name" id="pname" class="productName form-control input-sm" placeholder="Enter Product Name" required ng-minlength="3"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7">
                                <input type="text" ng-model="ctrl.user.age" id="Product Quantity" class="form-control input-sm" placeholder="Enter your Age." required ng-pattern="ctrl.onlyIntegers"/>
                            </div>
                        </div>
                    </div>
